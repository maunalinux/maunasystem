...
TIMESTAMPS = "/var/log/maunasystem.timestamps"
...
class MaunaSystem():
    ...
    def __init__(self):
        ...
        self.logfile = open("/var/log/maunasystem.log", "w")
        self.time_log("maunaSystem started")
        self.executed = []
        self.overwritten = []
        self.skipped = []
        self.edited = []
    ...
    def adjust(self):
        try:
            ...
            try:
                ...
                config.read('/etc/mauna/maunaSystem.conf')
                ...
                with open('/etc/mauna/maunaSystem.conf', 'w') as configfile:
            ...
            adjustment_directory = "/usr/share/mauna/adjustments/"
